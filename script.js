...
/* Restart UI removed — provide no-op helpers to avoid runtime references */
function showRestartBtn(){ /* no-op: restart UI removed */ }
function hideRestartBtn(){ /* no-op: restart UI removed */ }
